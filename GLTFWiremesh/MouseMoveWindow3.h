...
namespace gte
{
    class MouseMoveWindow3 : public Window
    {
    protected:
        // Abstract base class.
        MouseMoveWindow3(Parameters& parameters);
    ...
    protected:
        ...
        FreeMouseCameraRig mFreeMouseCameraRig;
        PVWUpdater mPVWMatrices;
        TrackBall mTrackBall;

        int mouse_x, mouse_y;
        const int MOUSE_MOVE_UP = 0, MOUSE_MOVE_DOWN = 1, MOUSE_MOVE_LEFT = 2, MOUSE_MOVE_RIGHT = 3;
    };
}
